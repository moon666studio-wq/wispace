...
create table if not exists public.merch_items (
  ...
  weight_gram integer not null default 1000,
  image_name text,
  image_preview text,
  genre text,
  city text,
...
create table if not exists public.merch_orders (
  ...
  shipment_booking_status text,
  shipping_payment_status text,
...
add column if not exists weight_gram integer not null default 1000,
...
add column if not exists shipping_cost integer not null default 0,
add column if not exists origin_shipping jsonb,
add column if not exists destination_shipping jsonb,
add column if not exists weight_gram integer not null default 1000,
add column if not exists fulfillment_mode text not null default 'band_ship',
add column if not exists consignment_status text,
...
add column if not exists shipment_booking_status text,
add column if not exists shipping_payment_status text,
